...
const sections = [
  {
    "title": "Start Hallway",
    "body": "Hallway is a clean first check because movement or silhouette changes are easier to catch when your loop begins there."
  },
  {
    "title": "Sweep Storage",
    "body": "Storage is likely to have more visual clutter, so look for displacement and signal feedback rather than one specific invented object."
  },
  {
    "title": "Reset in Office",
    "body": "Office works as a detail checkpoint. Use it to slow your eyes down after a purge."
  },
  {
    "title": "End Generator",
    "body": "Generator belongs at the end of each loop because blackout pressure is the central failure threat."
  }
];

const faqs = [
  {
    question: "Is SHIFT_MONITOR: 1998 Camera Guide official?",
...
export default function InfoPage() {
  const schemas = [
    buildBreadcrumbSchema([
      ...
      { name: "SHIFT_MONITOR: 1998 Camera Guide", item: absoluteUrl("/camera-guide/") },
    ]),
    buildFAQSchema(faqs),
  ];
    ...
    <>
      ...
      <main className="page-shell py-10">
        <section className="mb-10 max-w-4xl">
          ...
          <h1 className="font-mono text-4xl font-black tracking-tight text-white sm:text-5xl">SHIFT_MONITOR: 1998 Camera Guide</h1>
          <p className="mt-4 text-base leading-7 text-slate-300">The official page lists four active CCTV feeds. This guide turns them into a repeatable route so you can spend less time guessing.</p>
          <div className="mt-6 flex flex-wrap gap-3">
            <a href={config.game.officialUrl} target="_blank" rel="noopener noreferrer" className="btn-primary">
              Official itch.io
              <ExternalLink className="h-5 w-5" />
            </a>
            <Link href="/survival-tips" className="btn-secondary">
              Tune Survival Route
